                    ...
                    <div class="vstack gap-4 pt-2 mt-4">
                        <div>
                            <div class="hstack justify-content-between">
                                ...
                                <h6 class="fs-3 fw-medium text-dark lh-base mb-0">
                                    {{ number_format($listWithUsRequests, 2) }}%
                                </h6>
                            </div>
                            <div class="progress mt-6" role="progressbar" aria-label="Pending Requests"
                                aria-valuenow="{{ number_format($listWithUsRequests, 2) }}" aria-valuemin="0"
                                aria-valuemax="100">
                                <div class="progress-bar bg-warning"
                                    style="width: {{ number_format($listWithUsRequests, 2) }}%"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="hstack justify-content-between">
                                ...
                                <h6 class="fs-3 fw-medium text-dark lh-base mb-0">
                                    {{ number_format($availableProperties, 2) }}%
                                </h6>
                            </div>
                            <div class="progress mt-6" role="progressbar" aria-label="Available Properties"
                                aria-valuenow="{{ number_format($availableProperties, 2) }}" aria-valuemin="0"
                                aria-valuemax="100">
                                <div class="progress-bar bg-secondary"
                                    style="width: {{ number_format($availableProperties, 2) }}%"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="hstack justify-content-between">
                                ...
                                <h6 class="fs-3 fw-medium text-dark lh-base mb-0">
                                    {{ number_format($soldProperties, 2) }}%
                                </h6>
                            </div>
                            <div class="progress mt-6" role="progressbar" aria-label="Sold Properties"
                                aria-valuenow="{{ number_format($soldProperties, 2) }}" aria-valuemin="0"
                                aria-valuemax="100">
                                <div class="progress-bar bg-success"
                                    style="width: {{ number_format($soldProperties, 2) }}%"></div>
                            </div>
                        </div>
